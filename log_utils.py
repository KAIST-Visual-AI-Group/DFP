...
def get_exp_name(seed, extra_tags=None):
...
def setup_wandb(
    ...
    run = _wandb_init_with_retry(init_kwargs)
...
def _wandb_init_with_retry(init_kwargs, base_delay=10, max_delay=300):
    """Retry wandb.init indefinitely with exponential backoff until it succeeds."""
    ...
    while True:
        ...
        try:
            ...
            print(
                f'[setup_wandb] wandb.init attempt {attempt} failed: {type(e).__name__}: {e}. '
